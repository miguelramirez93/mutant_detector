...
// GetVerticalCoincidences return nitrogen base horizontal coincidences in the given dna matrix
// If macCoincidences > 0 will stop after find maxCoincidences.
...
// GetObliqueCoincidences return nitrogen base horizontal coincidences in the given dna matrix
// If macCoincidences > 0 will stop after find maxCoincidences.
func GetObliqueCoincidences(dna []string, repeatRange, maxCoincidences int) int {
