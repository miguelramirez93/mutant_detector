...
// GetObliqueDowmRightCoincidences return nitrogen base down right coincidences in the given dna matrix
// If maxCoincidences > 0 will stop after find maxCoincidences.
func GetObliqueDowmRightCoincidences(dna []string, repeatRange, maxCoincidences int, withMainDiag bool) int {
