...
var (
	...
	//DnaHumanInput dna data with spected format and spected result as human
	DnaHumanInput = []string{"ATGCGA", "CAGTGC", "TTATTT", "AGACGG", "GCGTCA", "TCACTG"}
	...
	DnaWrongLeterInput = []string{"ATGCGA", "CAGTGC", "TTATGT", "AGAAGG", "CCCCTA", "TCACHA"}
